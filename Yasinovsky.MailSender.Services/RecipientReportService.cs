...
namespace GeneratedCode
{
    public class GeneratedClass
    {
        ...
        public void CreatePackage(string filePath, IEnumerable<Recipient> recipients)
        {
            using (SpreadsheetDocument package = SpreadsheetDocument.Create(filePath, SpreadsheetDocumentType.Workbook))
            {
                CreateParts(package, recipients);
            }
        }

        // Adds child parts and generates content of the specified part.
        private void CreateParts(SpreadsheetDocument document, IEnumerable<Recipient> recipients)
        {
            ...
            var row =  GenerateWorksheetPart1Content(worksheetPart1, recipients);

            TableDefinitionPart tableDefinitionPart1 = worksheetPart1.AddNewPart<TableDefinitionPart>("rId2");
            GenerateTableDefinitionPart1Content(tableDefinitionPart1, row);
            ...
            GenerateCalculationChainPart1Content(calculationChainPart1, row);
        ...
        private void GenerateExtendedFilePropertiesPart1Content(ExtendedFilePropertiesPart extendedFilePropertiesPart1)
        {
            ...
            vTLPSTR2.Text = "Recipients Report Sheet";
        ...
        private void GenerateWorkbookPart1Content(WorkbookPart workbookPart1)
        {
            ...
            FileVersion fileVersion1 = new FileVersion() { ApplicationName = "xl", LastEdited = "7", LowestEdited = "7", BuildVersion = "20827" };
            ...
            X15ac.AbsolutePath absolutePath1 = new X15ac.AbsolutePath() { Url = "C:\\Users\\XYZtn21\\Documents\\My Shapes\\" };
            ...
            OpenXmlUnknownElement openXmlUnknownElement1 = OpenXmlUnknownElement.CreateOpenXmlUnknownElement("<xr:revisionPtr revIDLastSave=\"0\" documentId=\"13_ncr:1_{23D4D421-1F38-417C-A802-09B16B04529D}\" xr6:coauthVersionLast=\"37\" xr6:coauthVersionMax=\"37\" xr10:uidLastSave=\"{00000000-0000-0000-0000-000000000000}\" xmlns:xr10=\"http://schemas.microsoft.com/office/spreadsheetml/2016/revision10\" xmlns:xr6=\"http://schemas.microsoft.com/office/spreadsheetml/2016/revision6\" xmlns:xr=\"http://schemas.microsoft.com/office/spreadsheetml/2014/revision\" />");

            BookViews bookViews1 = new BookViews();

            WorkbookView workbookView1 = new WorkbookView() { XWindow = 4650, YWindow = 0, WindowWidth = (UInt32Value)27870U, WindowHeight = (UInt32Value)12810U };
            workbookView1.SetAttribute(new OpenXmlAttribute("xr2", "uid", "http://schemas.microsoft.com/office/spreadsheetml/2015/revision2", "{95BF2417-670A-4B6C-AE30-0CA3B37665AA}"));

            bookViews1.Append(workbookView1);

            Sheets sheets1 = new Sheets();
            Sheet sheet1 = new Sheet() { Name = "Recipients Report Sheet", SheetId = (UInt32Value)1U, Id = "rId1" };
        ...
        private void GenerateWorkbookStylesPart1Content(WorkbookStylesPart workbookStylesPart1)
        {
            ...
            Color color2 = new Color() { Theme = (UInt32Value)3U };
            ...
            Color color5 = new Color() { Theme = (UInt32Value)4U };

            topBorder2.Append(color5);

            BottomBorder bottomBorder2 = new BottomBorder() { Style = BorderStyleValues.Double };
            Color color6 = new Color() { Theme = (UInt32Value)4U };
            ...
            CellFormat cellFormat2 = new CellFormat() { NumberFormatId = (UInt32Value)0U, FontId = (UInt32Value)1U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)0U, ApplyNumberFormat = false, ApplyFill = false, ApplyBorder = false, ApplyAlignment = false, ApplyProtection = false };
            CellFormat cellFormat3 = new CellFormat() { NumberFormatId = (UInt32Value)0U, FontId = (UInt32Value)2U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)1U, ApplyNumberFormat = false, ApplyFill = false, ApplyAlignment = false, ApplyProtection = false };
            ...
            CellFormat cellFormat5 = new CellFormat() { NumberFormatId = (UInt32Value)0U, FontId = (UInt32Value)3U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)0U, FormatId = (UInt32Value)0U, ApplyFont = true };
            CellFormat cellFormat6 = new CellFormat() { NumberFormatId = (UInt32Value)0U, FontId = (UInt32Value)2U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)1U, FormatId = (UInt32Value)2U };
            ...
            CellFormat cellFormat9 = new CellFormat() { NumberFormatId = (UInt32Value)0U, FontId = (UInt32Value)1U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)0U, FormatId = (UInt32Value)1U, ApplyAlignment = true };
            ...
            CellStyle cellStyle2 = new CellStyle() { Name = "Title", FormatId = (UInt32Value)1U, BuiltinId = (UInt32Value)15U };
            CellStyle cellStyle3 = new CellStyle() { Name = "Total", FormatId = (UInt32Value)2U, BuiltinId = (UInt32Value)25U };
            ...
            Color color7 = new Color() { Theme = (UInt32Value)10U };
            ...
            Alignment alignment3 = new Alignment() { Horizontal = HorizontalAlignmentValues.Center, Vertical = VerticalAlignmentValues.Center, TextRotation = (UInt32Value)0U, WrapText = false, Indent = (UInt32Value)0U, JustifyLastLine = false, ShrinkToFit = false, ReadingOrder = (UInt32Value)0U };
        ...
        private uint GenerateWorksheetPart1Content(WorksheetPart worksheetPart1, IEnumerable<Recipient> recipients)
        {
            ...
            worksheet1.SetAttribute(new OpenXmlAttribute("xr", "uid", "http://schemas.microsoft.com/office/spreadsheetml/2014/revision", "{442E67C3-E463-42C3-8880-AC04E7C14BF6}"));
            SheetDimension sheetDimension1 = new SheetDimension() { Reference = "A1:C7" };

            SheetViews sheetViews1 = new SheetViews();

            SheetView sheetView1 = new SheetView() { TabSelected = true, WorkbookViewId = (UInt32Value)0U };
            Selection selection1 = new Selection() { SequenceOfReferences = new ListValue<StringValue>() { InnerText = "A1:C3" } };
            ...
            Column column1 = new Column() { Min = (UInt32Value)1U, Max = (UInt32Value)1U, Width = 12.7109375D, CustomWidth = true };
            Column column2 = new Column() { Min = (UInt32Value)2U, Max = (UInt32Value)2U, Width = 17.5703125D, CustomWidth = true };
            Column column3 = new Column() { Min = (UInt32Value)3U, Max = (UInt32Value)3U, Width = 23.28515625D, CustomWidth = true };
            ...
            Cell cell1 = new Cell() { CellReference = "A1", StyleIndex = (UInt32Value)5U, DataType = CellValues.String };
            CellValue cellValue1 = new CellValue("Recipient Report");
            ...
            Cell cell4 = new Cell() { CellReference = "A2", StyleIndex = (UInt32Value)5U };
            Cell cell5 = new Cell() { CellReference = "B2", StyleIndex = (UInt32Value)5U };
            Cell cell6 = new Cell() { CellReference = "C2", StyleIndex = (UInt32Value)5U };
            ...
            Cell cell7 = new Cell() { CellReference = "A3", StyleIndex = (UInt32Value)5U };
            Cell cell8 = new Cell() { CellReference = "B3", StyleIndex = (UInt32Value)5U };
            Cell cell9 = new Cell() { CellReference = "C3", StyleIndex = (UInt32Value)5U };

            row3.Append(cell7);
            row3.Append(cell8);
            row3.Append(cell9);

            Row row4 = new Row() { RowIndex = (UInt32Value)4U, Spans = new ListValue<StringValue>() { InnerText = "1:3" }, Height = 15.75D, ThickBot = true, DyDescent = 0.3D };

            Cell cell10 = new Cell() { CellReference = "A4", StyleIndex = (UInt32Value)2U, DataType = CellValues.String };
            CellValue cellValue2 = new CellValue("Created Date:");

            cell10.Append(cellValue2);

            Cell cell11 = new Cell() { CellReference = "B4", StyleIndex = (UInt32Value)3U, DataType = CellValues.String};
            CellValue cellValue3 = new CellValue(DateTime.Now);
            cell11.Append(cellValue3);

            row4.Append(cell10);
            row4.Append(cell11);

            Row row5 = new Row() { RowIndex = (UInt32Value)5U, Spans = new ListValue<StringValue>() { InnerText = "1:3" }, Height = 15.75D, ThickTop = true, DyDescent = 0.25D };

            Cell cell12 = new Cell() { CellReference = "A5", StyleIndex = (UInt32Value)4U, DataType = CellValues.String };
            CellValue cellValue4 = new CellValue("Id");

            cell12.Append(cellValue4);

            Cell cell13 = new Cell() { CellReference = "B5", StyleIndex = (UInt32Value)4U, DataType = CellValues.String };
            CellValue cellValue5 = new CellValue("FullName");

            cell13.Append(cellValue5);

            Cell cell14 = new Cell() { CellReference = "C5", StyleIndex = (UInt32Value)4U, DataType = CellValues.String };
            CellValue cellValue6 = new CellValue("EmailAddress");
            ...
            foreach (var item in recipients)
            {
                ...
                Row row6 = new Row() { RowIndex = row, Spans = new ListValue<StringValue>() { InnerText = "1:3" }, DyDescent = 0.25D };

                Cell cell15 = new Cell() { CellReference = "A" + row, CellValue = new CellValue(item.Id) };

                Cell cell16 = new Cell() { CellReference = "B" + row, CellValue = new CellValue(item.Name)};

                Cell cell17 = new Cell() { CellReference = "C" + row, CellValue = new CellValue(item.Address)};

                row6.Append(cell15, cell16, cell17);
            ...
            Row row7 = new Row() { RowIndex = row, Spans = new ListValue<StringValue>() { InnerText = "1:3" }, DyDescent = 0.25D };

            Cell cell18 = new Cell() { CellReference = "A" + row, DataType = CellValues.String };
            CellValue cellValue10 = new CellValue();
            cellValue10.Text = "Total:";

            cell18.Append(cellValue10);

            Cell cell19 = new Cell() { CellReference = "C" + row, StyleIndex = (UInt32Value)1U };
            CellFormula cellFormula1 = new CellFormula();
            cellFormula1.Text = "SUBTOTAL(103,Recipients[EmailAddress])";
            CellValue cellValue11 = new CellValue();
            cellValue11.Text = "1";

            cell19.Append(cellFormula1);
            cell19.Append(cellValue11);
            ...
            MergeCell mergeCell1 = new MergeCell() { Reference = "A1:C3" };
        ...
        private void GenerateTableDefinitionPart1Content(TableDefinitionPart tableDefinitionPart1, uint row)
        {
            Table table1 = new Table() { Id = (UInt32Value)1U, Name = "Recipients", DisplayName = "Recipients", Reference = "A5:C" + row , TotalsRowCount = (UInt32Value)1U, HeaderRowFormatId = (UInt32Value)1U, MCAttributes = new MarkupCompatibilityAttributes() { Ignorable = "xr xr3" } };
            ...
            table1.SetAttribute(new OpenXmlAttribute("xr", "uid", "http://schemas.microsoft.com/office/spreadsheetml/2014/revision", "{FFA870CA-DFA4-4698-AEE1-9177CC3910C9}"));

            AutoFilter autoFilter1 = new AutoFilter() { Reference = "A5:C6" };
            autoFilter1.SetAttribute(new OpenXmlAttribute("xr", "uid", "http://schemas.microsoft.com/office/spreadsheetml/2014/revision", "{158791B6-7B33-4032-92F8-1EDA46AB2BB8}"));

            SortState sortState1 = new SortState() { Reference = "A6:C6" };
            SortCondition sortCondition1 = new SortCondition() { Reference = "A5:A6" };

            sortState1.Append(sortCondition1);

            TableColumns tableColumns1 = new TableColumns() { Count = (UInt32Value)3U };

            TableColumn tableColumn1 = new TableColumn() { Id = (UInt32Value)1U, Name = "Id", TotalsRowLabel = "Total" };
            tableColumn1.SetAttribute(new OpenXmlAttribute("xr3", "uid", "http://schemas.microsoft.com/office/spreadsheetml/2016/revision3", "{24E6F278-940E-4EAA-8598-89AAB87A99ED}"));

            TableColumn tableColumn2 = new TableColumn() { Id = (UInt32Value)2U, Name = "FullName" };
            tableColumn2.SetAttribute(new OpenXmlAttribute("xr3", "uid", "http://schemas.microsoft.com/office/spreadsheetml/2016/revision3", "{7FB567D7-D39C-4ED6-90CA-F31F936C0797}"));

            TableColumn tableColumn3 = new TableColumn() { Id = (UInt32Value)3U, Name = "EmailAddress", TotalsRowFunction = TotalsRowFunctionValues.Count, TotalsRowDifferentialFormattingId = (UInt32Value)0U, DataCellStyle = "Normal" };
            tableColumn3.SetAttribute(new OpenXmlAttribute("xr3", "uid", "http://schemas.microsoft.com/office/spreadsheetml/2016/revision3", "{C327A23F-7FBD-4529-BA1D-0E78F0144AD1}"));

            tableColumns1.Append(tableColumn1);
            tableColumns1.Append(tableColumn2);
            tableColumns1.Append(tableColumn3);
            TableStyleInfo tableStyleInfo1 = new TableStyleInfo() { Name = "TableStyleMedium16", ShowFirstColumn = true, ShowLastColumn = false, ShowRowStripes = true, ShowColumnStripes = false };
        ...
        private void GenerateCalculationChainPart1Content(CalculationChainPart calculationChainPart1, uint row)
        {
            CalculationChain calculationChain1 = new CalculationChain();
            CalculationCell calculationCell1 = new CalculationCell() { CellReference = "C" + row, SheetId = 1, NewLevel = true };
        ...
        private void GenerateSharedStringTablePart1Content(SharedStringTablePart sharedStringTablePart1)
        {
            ...
            Text text2 = new Text();
            text2.Text = "Full Name";

            sharedStringItem2.Append(text2);

            SharedStringItem sharedStringItem3 = new SharedStringItem();
            Text text3 = new Text();
            text3.Text = "Email Address";

            sharedStringItem3.Append(text3);

            SharedStringItem sharedStringItem4 = new SharedStringItem();
            Text text4 = new Text();
            text4.Text = "Created date:";
            ...
            Text text7 = new Text();
            text7.Text = "email_address";

            sharedStringItem7.Append(text7);

            SharedStringItem sharedStringItem8 = new SharedStringItem();
            Text text8 = new Text();
            text8.Text = "Recipients Report";
        ...
        {
            document.PackageProperties.Creator = "XYZtn21";
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2021-03-16T05:05:39Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2021-03-16T07:16:46Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.LastModifiedBy = "XYZtn21";
        }
